...
import {Drawer, Col, Row, Tag, Button, Popover, Modal, Form, Input, message, Switch} from 'antd'
...
import {url, GET_RTMP_URL, ADD_RTMP_URL, DEL_RTMP_URL, change_remote_config, hostname} from '../../common/urls'
...
class Student_analyze extends React.Component {
    ...
    constructor(props) {
        ...
        this._switchOnChange = this._switchOnChange.bind(this)
        this.socket_cam = 1
    }
    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            let options_1 = {
                ...
                sources: [{
                    type: "rtmp/flv",
                    src: `rtmp://${hostname}:1935/hls/002`,
                }],
            }
            ...
            let options_2 = {
                ...
                sources: [{
                    type: "rtmp/flv",
                    src: `rtmp://${hostname}:1935/hls/001`,
                }],
            }
            ...
            let options_3 = {
                ...
                sources: [{
                    type: "rtmp/flv",
                    src: `rtmp://${hostname}:1935/hls/003`,
                }],
            }

            let options_0_center = {
                autoplay:    true,
                controls:    false,
                preload:     true, //预加载
                fluid:       true, //播放器将具有流畅的大小。换句话说，它将扩展以适应其容器
                ...
                sources: [{
                    type: "rtmp/flv",
                    src: `rtmp://${hostname}:1935/hls/world`,
                }],
            }
            ...
            if (this.state.show_cam_1){
                ...
                this.player_3 = video(`example_video_3`,options_3);
            }
        })
    ...
    handleSubmitParsing = (e) => {
        _fetch(change_remote_config, {
            updateConfig: this.state.parsing
        }, (json)=>{
            if (json.code == 200){
                ...
                if (ip == "192.168.88.27"){
                    ...
                    this.setState({
                        ...
                        let options = {
                            ...
                            sources: [{
                                type: "rtmp/flv",
                                src: "rtmp://172.16.104.80:1935/hls/000",
                            }],
                        }
                        ...
                        let options_1 = {
                            ...
                            sources: [{
                                type: "rtmp/flv",
                                src: "rtmp://172.16.104.80:1935/hls/002",
                            }],
                        }
                        ...
                        let options_2 = {
                            ...
                            sources: [{
                                type: "rtmp/flv",
                                src: "rtmp://172.16.104.80:1935/hls/001",
                            }],
                        }
                        ...
                        let options_3 = {
                            ...
                            sources: [{
                                type: "rtmp/flv",
                                src: "rtmp://172.16.104.80:1935/hls/003",
                            }],
                        }
    ...
    waring_img_history = (persons_arr, length)=>{
        ...
        let persons_history = persons.map((person, i)=>{
            ...
            if (Math.abs(person.id) == 420 || Math.abs(person.id) == 421 || Math.abs(person.id) == 423){
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {/*    配置*/}
                {/*</Button>*/}
                {/*<Switch checkedChildren="开" unCheckedChildren="关" defaultChecked style={{*/}
                {/*    marginLeft:10, position:'absolute', top:20*screen_scale_height, right:25*/}
                {/*}}/>*/}
                <div className="Mode_1" style={styles.wrap_div}>
                    ...
                    >
                        <Form layout='horizontal' style={{margin: '0 auto'}} onSubmit={this.handleSubmitParsing}>
                            ...
                            {/*    }*/}
                            {/*</FormItem>*/}
                            <FormItem label='parsing: ' {...formItemLayout}>
                                {
                                    getFieldDecorator('parsing', {
                                        initialValue:"",
                                    })(
                                        <Switch checkedChildren="开" unCheckedChildren="关"
                                                // defaultChecked
                                                onChange={this._switchOnChange}
                                        />
                                    )
                                }
                            </FormItem>

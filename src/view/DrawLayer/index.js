...
import fishEyePic from '../../asset/test/1115_fish.jpg'
...
const canvasWidht = 464
const canvasHeight = 464
const img_left = '25%'
                ...
                <Row className={'drawLayer'} gutter={12} style={styles.wrap_div} type="flex" justify="space-around" align="middle" >
                    ...
                    <Col span={16} style={styles.content_1_1}>
                        <div style={{position:'relative', display:'flex', flexDirection:"column",
                            ...
                            <img src={this.state.selectImg.src} width={'50%'} style={{zIndex:89, marginLeft:img_left}}/>
